...
void __attribute__((picinterrupt(("high_priority")))) high_isr(void){
    ...
    if( INTCONbits.TMR0IE && INTCONbits.TMR0IF ) {
        ...
        switch( display_cnt ){
            case 0: WriteTimer0( 65485 ); break;
            case 1: WriteTimer0( 65485 ); break;
            case 2: WriteTimer0( 65485 ); break;
            case 3: WriteTimer0( 65485 ); break;
            case 4: WriteTimer0( 65485 ); break;
            case 5: WriteTimer0( 65485 ); break;
            case 6: WriteTimer0( 65485 ); break;
            case 7: WriteTimer0( 65285 ); break;
        }
        ScanDisplay();
        ScanButtons();
        cnt ++;
        if( cnt == 100 ){
            ...
            if( btn_long_press_verify_flg ){
                long_pressed_cnt ++; if( long_pressed_cnt > 10 ) long_pressed_cnt = 10;
                CONTINUE_PRESSED_TIME = 100 / long_pressed_cnt;
            }
            else {
                long_pressed_cnt = 0;
