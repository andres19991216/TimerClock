...
#define LAP_LED_ON        0x04
#define LAP_LED_OFF       0xfb
#define RESET_LED_ON      0x40
#define RESET_LED_OFF     0xbf
#define START_LED_ON      0x10
#define START_LED_OFF     0xef
#define STOP_LED_ON       0x20
#define STOP_LED_OFF      0xdf

#define LED_BLINK_TIME    640
