...
unsigned char rtc_default_values[10] = {0x10,0x12,0x09,0x05,0x03,0x11,0x23,'\0'};
...
void ScanButtons(){
    ...
    if( PORTDbits.RD6 == 0 ) { sel_btn_released_cnt = 0; sel_btn_pressed_cnt ++; BTN_CLICK_EVENT = 4; }
    if( PORTDbits.RD6 == 1 && BTN_CLICK_EVENT == 4 ){ sel_btn_pressed_cnt = 0; sel_btn_released_cnt ++; }

    if( PORTBbits.RB4 == 0 ) { reset_btn_released_cnt = 0; reset_btn_pressed_cnt ++; BTN_CLICK_EVENT = 5; }
    if( PORTBbits.RB4 == 1 && BTN_CLICK_EVENT == 5 ){ reset_btn_pressed_cnt = 0; reset_btn_released_cnt ++; }
...
void VerifyButtons(){
    ...
    switch( BTN_CLICK_EVENT ) {
        ...
        case 1: if( hour_btn_pressed_cnt > 800 ) { btn_long_press_verify_flg = 1; hour_btn_pressed_cnt = 800; }
                else if( hour_btn_pressed_cnt > 100 ) btn_press_verify_flg = 1;
                if( hour_btn_released_cnt > 40 ) {
                    hour_btn_released_cnt = 0; BTN_CLICK_EVENT = 0;
                    if( btn_long_press_verify_flg ) { BTN_CLICK_STATE = 16; btn_long_press_verify_flg = 0; }
                    else if( btn_press_verify_flg ) { BTN_CLICK_STATE = 11; btn_press_verify_flg = 0; }
                }
                ActionButtons(); break;

        case 2: if( up_btn_pressed_cnt > 800 ) { btn_long_press_verify_flg = 1; up_btn_pressed_cnt = 800; }
                else if( up_btn_pressed_cnt > 100 ) btn_press_verify_flg = 1;
                if( up_btn_released_cnt > 40 ) {
                    up_btn_released_cnt = 0; BTN_CLICK_EVENT = 0;
                    if( btn_long_press_verify_flg ) { BTN_CLICK_STATE = 17; btn_long_press_verify_flg = 0; }
                    else if( btn_press_verify_flg ) { BTN_CLICK_STATE = 12; btn_press_verify_flg = 0; }
                }
                ActionButtons(); break;

        case 3: if( down_btn_pressed_cnt > 800 ) { btn_long_press_verify_flg = 1; down_btn_pressed_cnt = 800; }
                else if( down_btn_pressed_cnt > 100 ) btn_press_verify_flg = 1;
                if( down_btn_released_cnt > 40 ) {
                    down_btn_released_cnt = 0; BTN_CLICK_EVENT = 0;
                    if( btn_long_press_verify_flg ) { BTN_CLICK_STATE = 18; btn_long_press_verify_flg = 0; }
                    else if( btn_press_verify_flg ) { BTN_CLICK_STATE = 13; btn_press_verify_flg = 0; }
                }
                ActionButtons(); break;

        case 4: if( sel_btn_pressed_cnt > 800 ) { btn_long_press_verify_flg = 1; sel_btn_pressed_cnt = 800; }
                else if( sel_btn_pressed_cnt > 100 ) btn_press_verify_flg = 1;
                if( sel_btn_released_cnt > 40 ) {
                    sel_btn_released_cnt = 0; BTN_CLICK_EVENT = 0;
                    if( btn_long_press_verify_flg ) { BTN_CLICK_STATE = 19; btn_long_press_verify_flg = 0; }
                    else if( btn_press_verify_flg ) { BTN_CLICK_STATE = 14; btn_press_verify_flg = 0; }
                }
                ActionButtons(); break;

        case 5: if( reset_btn_pressed_cnt > 800 ) { btn_long_press_verify_flg = 1; reset_btn_pressed_cnt = 800; }
                else if( reset_btn_pressed_cnt > 100 ) btn_press_verify_flg = 1;
                if( reset_btn_released_cnt > 40 ) {
                    reset_btn_released_cnt = 0; BTN_CLICK_EVENT = 0;
                    if( btn_long_press_verify_flg ) { BTN_CLICK_STATE = 20; btn_long_press_verify_flg = 0; }
                    else if( btn_press_verify_flg ) { BTN_CLICK_STATE = 15; btn_press_verify_flg = 0; }
                }
                ActionButtons(); break;
    }
}
...
void ActionButtons(){
    ...
    switch( SYSTEM_STATE_FLG ){
        ...
        case 100:
            switch( BTN_CLICK_STATE ) {
                case 19:
                    SYSTEM_STATE_FLG = 201; BTN_CLICK_STATE = 0;
                    counter_direction_flg = 1; blink_enable_flg = 0; temp_system_state = SYSTEM_STATE_FLG;
                    SetCounter( counter_hour_set_value, counter_min_set_value, counter_sec_set_value ); StopCounter();
                    return;
                case 14:
                    if( rtc_clock_disp_type == 0 ) rtc_clock_disp_type = 1;
                    else rtc_clock_disp_type = 0;
                    BTN_CLICK_STATE = 0; Ds1307Write( &real_rtc_data );
                    return;
                case 15:
                    rtc_clock_disp_mode ++;
                    if( rtc_clock_disp_mode >= 3 ) rtc_clock_disp_mode = 0;
                    BTN_CLICK_STATE = 0;
                    return;
                case 16:
                    SYSTEM_STATE_FLG = 101; rtc_clock_set_mode = 0;
                    blink_enable_flg = 2; BTN_CLICK_STATE = 0;
                    return;
                case 17:
                    SYSTEM_STATE_FLG = 105; rtc_clock_set_mode = 1;
                    blink_enable_flg = 2; BTN_CLICK_STATE = 0;
                    return;
                case 18:
                    SYSTEM_STATE_FLG = 104; rtc_clock_set_mode = 2;
                    blink_enable_flg = 2; BTN_CLICK_STATE = 0;
                    return;
            }
            break;
        ...
        case 101:
            switch( BTN_CLICK_STATE ) {
                case 12:
                    temp = real_rtc_data[ 6 ]; temp ++;
                    if( temp % 16 >= 10 ) temp += 6; if( temp > 0x99 ) temp = 23;
                    real_rtc_data[ 6 ] = temp;
                    BTN_CLICK_STATE = 0;
                    return;
                case 13:
                    temp = real_rtc_data[ 6 ]; temp --;
                    ...
                    return;
                case 11:
                    SYSTEM_STATE_FLG = 102; blink_enable_flg = 3; BTN_CLICK_STATE = 0;
                    return;
                case 20:
                    SYSTEM_STATE_FLG = 100; blink_enable_flg = 1; BTN_CLICK_STATE = 0;
        ...
        case 102:
            switch( BTN_CLICK_STATE ) {
                case 12:
                    temp = real_rtc_data[ 5 ]; temp ++;
                    if( temp % 16 >= 10 ) temp += 6; if( temp > 0x12 ) temp = 1;
                    real_rtc_data[ 5 ] = temp;
                    BTN_CLICK_STATE = 0;
                    return;
                case 13:
                    temp = real_rtc_data[ 5 ]; temp --;
                    ...
                    return;
                case 11:
                    SYSTEM_STATE_FLG = 103; blink_enable_flg = 4; BTN_CLICK_STATE = 0;
                    return;
                case 20:
                    SYSTEM_STATE_FLG = 100; blink_enable_flg = 1; BTN_CLICK_STATE = 0;
                    Ds1307Write( &real_rtc_data ); return;
        ...
        case 103:
            switch( BTN_CLICK_STATE ) {
                case 12:
                    temp = real_rtc_data[ 4 ]; temp ++;
                    if( temp % 16 >= 10 ) temp += 6; if( temp > 0x31 ) temp = 1;
                    real_rtc_data[ 4 ] = temp;
                    BTN_CLICK_STATE = 0;
                    return;
                case 13:
                    temp = real_rtc_data[ 4 ]; temp --;
                    ...
                    return;
                case 11:
                    SYSTEM_STATE_FLG = 101; blink_enable_flg = 2; BTN_CLICK_STATE = 0;
                    return;
                case 20:
                    SYSTEM_STATE_FLG = 100; blink_enable_flg = 1; BTN_CLICK_STATE = 0;
                    Ds1307Write( &real_rtc_data ); return;
        ...
        case 105:
            switch( BTN_CLICK_STATE ) {
                ...
                case 13:
                    ...
                    return;
                case 11:
                    SYSTEM_STATE_FLG = 106; blink_enable_flg = 3; BTN_CLICK_STATE = 0;
                    return;
                case 20:
                    SYSTEM_STATE_FLG = 100; blink_enable_flg = 1; BTN_CLICK_STATE = 0;
                    Ds1307Write( &real_rtc_data ); return;
        ...
        case 106:
            switch( BTN_CLICK_STATE ) {
                ...
                case 13:
                    ...
                    return;
                case 11:
                    SYSTEM_STATE_FLG = 107; blink_enable_flg = 4; BTN_CLICK_STATE = 0;
                    return;
                case 20:
                    SYSTEM_STATE_FLG = 100; blink_enable_flg = 1; BTN_CLICK_STATE = 0;
                    Ds1307Write( &real_rtc_data ); return;
        ...
        case 107:
            switch( BTN_CLICK_STATE ) {
                ...
                case 13:
                    ...
                    return;
                case 11:
                    SYSTEM_STATE_FLG = 105; blink_enable_flg = 2; BTN_CLICK_STATE = 0;
                    return;
                case 20:
                    SYSTEM_STATE_FLG = 100; blink_enable_flg = 1; BTN_CLICK_STATE = 0;
                    Ds1307Write( &real_rtc_data ); return;
        ...
        case 104:
            switch( BTN_CLICK_STATE ) {
                case 12:
                    temp = real_rtc_data[ 3 ]; temp ++;
                    if( temp > 0x07 ) temp = 1;
                    real_rtc_data[ 3 ] = temp;
                    BTN_CLICK_STATE = 0;
                    return;
                case 13:
                    temp = real_rtc_data[ 3 ]; temp --;
                    ...
                    return;
                case 11:
                    SYSTEM_STATE_FLG = 108; blink_enable_flg = 3; BTN_CLICK_STATE = 0;
                    return;
                case 20:
                    SYSTEM_STATE_FLG = 100; blink_enable_flg = 1; BTN_CLICK_STATE = 0;
                    Ds1307Write( &real_rtc_data ); return;
        ...
        case 108:
            switch( BTN_CLICK_STATE ) {
                ...
                case 13:
                    ...
                    return;
                case 11:
                    SYSTEM_STATE_FLG = 104; blink_enable_flg = 2; BTN_CLICK_STATE = 0;
                    return;
                case 20:
                    SYSTEM_STATE_FLG = 100; blink_enable_flg = 1; BTN_CLICK_STATE = 0;
                    Ds1307Write( &real_rtc_data ); return;
        ...
        case 200:
            switch( BTN_CLICK_STATE ) {
                case 19:
                    SYSTEM_STATE_FLG = 100; blink_enable_flg = 1;
                    BTN_CLICK_STATE = 0; StopCounter();
                    return;
                case 14:
                    counter_skip_flg = 0;
    ...
    if( SYSTEM_STATE_FLG >= 201 && BTN_CLICK_STATE == 16 ){
        blink_enable_flg = 2; SYSTEM_STATE_FLG = 202;

        BTN_CLICK_STATE = 0; return;
    }


    if( SYSTEM_STATE_FLG >= 201 && BTN_CLICK_STATE == 17 ){
        blink_enable_flg = 3; SYSTEM_STATE_FLG = 203;

        BTN_CLICK_STATE = 0; return;
    }


    if( SYSTEM_STATE_FLG >= 201 && BTN_CLICK_STATE == 18 ){
        blink_enable_flg = 4; SYSTEM_STATE_FLG = 204;

        BTN_CLICK_STATE = 0; return;
    }


    if( SYSTEM_STATE_FLG >= 202 && BTN_CLICK_STATE == 20 ){
