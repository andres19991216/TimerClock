...
unsigned char* Ds1307Read( unsigned char disp_type ){
    ...
    rtc_clock_disp_type = ( real_rtc_data[ 2 ] & 0x40 ) ? 1 : 0;
    if( rtc_clock_disp_type == 0 ) real_rtc_data[ 2 ] = real_rtc_data[ 2 ] & 0x3f;
    else { rtc_hour_ampm_flg = ( real_rtc_data[ 2 ] & 0x20 ) ? 1 : 0; real_rtc_data[ 2 ] = real_rtc_data[ 2 ] & 0x1f; }

    switch( disp_type ) {
        case 0:
                ds1307_date_datas[ 0 ] = real_rtc_data[ 2 ] >> 4; ds1307_date_datas[ 1 ] = real_rtc_data[ 2 ] % 16;
                ds1307_date_datas[ 2 ] = real_rtc_data[ 1 ] >> 4; ds1307_date_datas[ 3 ] = real_rtc_data[ 1 ] % 16;
                ds1307_date_datas[ 4 ] = real_rtc_data[ 0 ] >> 4; ds1307_date_datas[ 5 ] = real_rtc_data[ 0 ] % 16;
                break;
        case 1:
                ds1307_date_datas[ 0 ] = real_rtc_data[ 2 ] >> 4; ds1307_date_datas[ 1 ] = real_rtc_data[ 2 ] % 16;
                ds1307_date_datas[ 2 ] = real_rtc_data[ 1 ] >> 4; ds1307_date_datas[ 3 ] = real_rtc_data[ 1 ] % 16;
                ds1307_date_datas[ 4 ] = real_rtc_data[ 3 ] >> 4; ds1307_date_datas[ 5 ] = real_rtc_data[ 3 ] % 16;
                break;
        case 2:
                ds1307_date_datas[ 0 ] = real_rtc_data[ 6 ] >> 4; ds1307_date_datas[ 1 ] = real_rtc_data[ 6 ] % 16;
                ds1307_date_datas[ 2 ] = real_rtc_data[ 5 ] >> 4; ds1307_date_datas[ 3 ] = real_rtc_data[ 5 ] % 16;
                ds1307_date_datas[ 4 ] = real_rtc_data[ 4 ] >> 4; ds1307_date_datas[ 5 ] = real_rtc_data[ 4 ] % 16;
                break;
        default: break;
    }
...
void Ds1307Write(unsigned char* write_datas){
    ...
    if( rtc_clock_disp_type == 1 ) {
        if( hour_temp > 0x12 ) hour_temp = hour_temp - 0x12;
        hour_temp = hour_temp | 0x40;
        if( rtc_hour_ampm_flg == 1 ) hour_temp = hour_temp | 0x20;
    }
    else {
        if( rtc_hour_ampm_flg == 1 && hour_temp < 0x12 ) hour_temp = hour_temp + 0x12;
    }
    ...
    I2cWrite( write_datas[ 0 ] ); _delay((unsigned long)((1)*(32000000UL/4000000.0)));
    I2cWrite( write_datas[ 1 ] ); _delay((unsigned long)((1)*(32000000UL/4000000.0)));
    I2cWrite( write_datas[ 2 ] ); _delay((unsigned long)((1)*(32000000UL/4000000.0)));
    I2cWrite( write_datas[ 3 ] ); _delay((unsigned long)((1)*(32000000UL/4000000.0)));
    I2cWrite( write_datas[ 4 ] ); _delay((unsigned long)((1)*(32000000UL/4000000.0)));
    I2cWrite( write_datas[ 5 ] ); _delay((unsigned long)((1)*(32000000UL/4000000.0)));
    I2cWrite( write_datas[ 6 ] ); _delay((unsigned long)((1)*(32000000UL/4000000.0)));
    I2cWrite( 0x90 ); _delay((unsigned long)((1)*(32000000UL/4000000.0)));
...
unsigned char GetDaysSymbol(unsigned char time_bcd_data) {
 ...
 unsigned char GetMonthsSymbol(unsigned char time_bcd_data) {
    ...
    switch(Ltemp)
    {
        case (0x30): if(Htemp == (0x31)) return 10; else return 200;
        case (0x31): if(Htemp == (0x31)) return 11; else return 1;
        case (0x32): if(Htemp == (0x31)) return 12; else return 2;
        case (0x33): return 3;
        case (0x34): return 4;
        case (0x35): return 5;
        case (0x36): return 6;
