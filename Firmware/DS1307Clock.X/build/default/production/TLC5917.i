...
void TLC5917Write(unsigned int data) {
    ...
    PORTAbits.RA0 = 0; PORTAbits.RA5 = 0; PORTAbits.RA3 = 1;
    for( unsigned char i = 0; i < 8; i++ ){
        PORTAbits.RA0 = (temp & 0x80) ? 1 : 0; _delay((unsigned long)((1)*(32000000UL/4000000.0)));
        PORTAbits.RA1 = 1; _delay((unsigned long)((1)*(32000000UL/4000000.0))); PORTAbits.RA1 = 0; _delay((unsigned long)((1)*(32000000UL/4000000.0)));
        temp = temp << 1;
    }
    PORTAbits.RA5 = 1; _delay((unsigned long)((1)*(32000000UL/4000000.0))); PORTAbits.RA5 = 0; _delay((unsigned long)((1)*(32000000UL/4000000.0)));
    PORTAbits.RA3 = 0; _delay((unsigned long)((2)*(32000000UL/4000000.0)));
}
