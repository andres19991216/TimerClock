...
void VerifyButtons(){
    ...
    switch( BTN_CLICK_EVENT ) {
        ...
        case 1: if( hour_btn_pressed_cnt > 3500 ) { if( !btn_long_press_verify_flg ) BTN_CLICK_STATE = 16; btn_long_press_verify_flg = 1; hour_btn_pressed_cnt = 3500; ActionButtons(); }
        ...
        case 2: if( up_btn_pressed_cnt > 3500 ) { if( !btn_long_press_verify_flg ) BTN_CLICK_STATE = 17; btn_long_press_verify_flg = 1; up_btn_pressed_cnt = 3500; ActionButtons(); }
                ...
                if( up_btn_released_cnt > 5 ) {
                    up_btn_released_cnt = 0; BTN_CLICK_EVENT = 0; BTN_CLICK_EVENT = 0; btn_long_press_verify_flg = 0; btn_press_verify_flg = 0;
                }
                break;

        case 3: if( down_btn_pressed_cnt > 3500 ) { if( !btn_long_press_verify_flg ) BTN_CLICK_STATE = 18; btn_long_press_verify_flg = 1; down_btn_pressed_cnt = 3500; ActionButtons(); }
                ...
                if( down_btn_released_cnt > 5 ) {
                    down_btn_released_cnt = 0; BTN_CLICK_EVENT = 0; BTN_CLICK_EVENT = 0; btn_long_press_verify_flg = 0; btn_press_verify_flg = 0;
                    if( btn_long_press_verify_flg ) { btn_long_press_verify_flg = 0; }
                    else if( btn_press_verify_flg ) { btn_press_verify_flg = 0; }
                }
                break;

        case 4: if( sel_btn_pressed_cnt > 3500 ) { if( !btn_long_press_verify_flg ) BTN_CLICK_STATE = 19; btn_long_press_verify_flg = 1; sel_btn_pressed_cnt = 3500; ActionButtons(); }
        ...
        case 5: if( reset_btn_pressed_cnt > 3500 ) { if( !btn_long_press_verify_flg ) BTN_CLICK_STATE = 20; btn_long_press_verify_flg = 1; reset_btn_pressed_cnt = 3500; ActionButtons(); }
    ...
    switch( SYSTEM_STATE_FLG ){
        ...
        case 203:
            switch( BTN_CLICK_STATE ) {
                ...
                case 20:
                    counter_direction_flg = 1 - counter_direction_flg;
                    SYSTEM_STATE_FLG = 201; StopCounter(); blink_enable_flg = 0;
                    BTN_CLICK_STATE = 0;
                    return;
            }
            break;
