...
unsigned char* ReadCounter(){
    ...
    unsigned char counter_datas[ 6 ];

    if( counter_direction_flg == 1 ) {
        counter_datas[ 0 + 1 ] = counter_up_hour % 10;
        counter_datas[ 0 ] = counter_up_hour / 10;
        counter_datas[ 2 + 1 ] = counter_up_minute % 10;
        counter_datas[ 2 ] = counter_up_minute / 10;
        counter_datas[ 4 + 1 ] = counter_up_second % 10;
        counter_datas[ 4 ] = counter_up_second / 10;
    }

    else if( counter_direction_flg == 0 ){
        counter_datas[ 0 + 1 ] = counter_down_hour % 10;
        counter_datas[ 0 ] = counter_down_hour / 10;
        counter_datas[ 2 + 1 ] = counter_down_minute % 10;
        counter_datas[ 2 ] = counter_down_minute / 10;
        counter_datas[ 4 + 1 ] = counter_down_second % 10;
        counter_datas[ 4 ] = counter_down_second / 10;
    }
...
void SetCounter( unsigned char hour, unsigned char minute, unsigned char second ){
    ...
    if( counter_direction_flg == 1 ) return;
    else if( counter_direction_flg == 0 ){
