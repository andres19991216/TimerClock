...
void ReadCounter( signed char* read_buffer ){
    ...
    if( counter_direction_flg == 1 ) {
        read_buffer[ 0 + 1 ] = counter_up_hour % 10;
        read_buffer[ 0 ] = counter_up_hour / 10;
        read_buffer[ 2 + 1 ] = counter_up_minute % 10;
        read_buffer[ 2 ] = counter_up_minute / 10;
        read_buffer[ 4 + 1 ] = counter_up_second % 10;
        read_buffer[ 4 ] = counter_up_second / 10;
    }

    else if( counter_direction_flg == 0 ){
        read_buffer[ 0 + 1 ] = counter_down_hour % 10;
        read_buffer[ 0 ] = counter_down_hour / 10;
        read_buffer[ 2 + 1 ] = counter_down_minute % 10;
        read_buffer[ 2 ] = counter_down_minute / 10;
        read_buffer[ 4 + 1 ] = counter_down_second % 10;
        read_buffer[ 4 ] = counter_down_second / 10;
    }
