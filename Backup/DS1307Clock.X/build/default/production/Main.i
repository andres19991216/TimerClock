...
void main(void) {
    ...
    while(1)
    {
        ...
        if( counter_down_comp_flg ) {
            BLINK_TIME = 80; blink_enable_flg = 5; counter_skip_flg = 0;
        }
        else {
            BLINK_TIME = 300;
        ...
        switch( SYSTEM_STATE_FLG ) {
            case 100: UpdateDisplay( Ds1307HMSRead(), 1, 6 ); break;
        }
        ...
        switch( SYSTEM_STATE_FLG ) {
            ...
            case 201:
            case 202:
            case 203: ReadCounter(display_datas); break;
        }
    }
}
...
void InitValue(){
    if( SYSTEM_STATE_FLG == 100 ){
        blink_enable_flg = 1; Ds1307Write( rtc_default_values );
    }
