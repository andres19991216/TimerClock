...
void OpenS5500(){
    ...
    PORTDbits.RD2 = 1; PORTDbits.RD0 = 1;

    OpenSPI( 0b00000000, 0b00000000, 0b00000000 );
    ...
    WriteNByteS5500( 0x0000, 0x80, 1 ); _delay((unsigned long)((1)*(32000000UL/4000.0)));
    WriteNByteS5500( 0x0001, gtw_addr, 4 ); _delay((unsigned long)((1)*(32000000UL/4000.0)));

    uint8_t temp1 = 0;
    temp1 = ReadByteS5500( 0x0001 );
    sprintf( temp, "W5500->%d\n" , temp1 );
    puts1USART( temp );

    WriteNByteS5500( 0x0005, sub_mask, 4 ); _delay((unsigned long)((1)*(32000000UL/4000.0)));
    WriteNByteS5500( 0x0009, mac_addr, 6 ); _delay((unsigned long)((1)*(32000000UL/4000.0)));
    WriteNByteS5500( 0x000F, ip_addr, 4 ); _delay((unsigned long)((1)*(32000000UL/4000.0)));

    for( uint8_t i = 0; i < 8; i++ ){
        WriteByteS5500Socket( i, 0x001e, 0x02 ); _delay((unsigned long)((1)*(32000000UL/4000.0)));
        WriteByteS5500Socket( i, 0x001f, 0x02 ); _delay((unsigned long)((1)*(32000000UL/4000.0)));
    }

    WriteNByteS5500( 0x0019, 0x07d0, 2 ); _delay((unsigned long)((1)*(32000000UL/4000.0)));
    WriteNByteS5500( 0x001b, 8, 1 ); _delay((unsigned long)((1)*(32000000UL/4000.0)));
    puts1USART( "W5500 Init Complete!\n" );
}

uint8_t ReadByteS5500( uint16_t addr ){
    uint8_t receive_data = 0;
    PORTDbits.RD2 = 0; _delay((unsigned long)((2)*(32000000UL/4000000.0)));
    WriteShortSPI1( addr );
    WriteByteSPI1( 0x00 | 0x00 | 0x00 );



    receive_data = ReadSPI(); _delay((unsigned long)((2)*(32000000UL/4000000.0)));
    PORTDbits.RD2 = 1;
    return receive_data;
}
...
uint8_t ReadByteS5500Socket( uint8_t socket_number, uint16_t addr ){
    ...
    WriteShortSPI1( addr );
    WriteByteSPI1( 0x00 | 0x00 | ( socket_number * 0x20 + 0x08 ) );
    receive_data = ReadByteSPI1(); __nop(); __nop();
    WriteByteSPI1( 0x00 );
    receive_data = ReadByteSPI1(); __nop(); __nop();
    PORTDbits.RD2 = 1;
    return receive_data;
...
uint16_t ReadShortS5500Socket( uint8_t socket_number, uint16_t addr ){
    ...
    receive_data = ReadByteSPI1(); __nop(); __nop();
    WriteByteSPI1( 0x00 );
    receive_data = receive_data * 256 + ReadByteSPI1(); __nop(); __nop();
    PORTDbits.RD2 = 1;
    return receive_data;
}
...
void WriteByteS5500Socket( uint8_t socket_number, uint16_t addr, uint8_t write_data ){
    ...
    WriteShortSPI1( addr );
    WriteByteSPI1( 0x00 | 0x04 | ( socket_number * 0x20 + 0x08 ) );
 WriteByteSPI1( write_data );
...
void CloseSocket( uint8_t socket_number )
{
    ...
    WriteByteS5500Socket( socket_number, 0x0001, 0x10 );

    while( ReadByteS5500Socket( socket_number, 0x0001 ) );
}

void DisconnectSocket( uint8_t socket_number )
{

    WriteByteS5500Socket( socket_number, 0x0001, 0x08 );
...
uint8_t InitSocket( uint8_t socket_number, uint8_t eth_protocol, uint16_t tcp_port )
{
    ...
    if ( ReadByteS5500Socket( socket_number, 0x0003 ) == 0x00 ) {
        CloseSocket( socket_number );
    }

    WriteByteS5500Socket( socket_number, 0x0000, eth_protocol );

    WriteShortS5500Socket( socket_number, 0x0004, tcp_port );
    WriteByteS5500Socket( socket_number, 0x0001, 0x01 );


    while( ReadByteS5500Socket( socket_number, 0x0001 ) );

    if ( ReadByteS5500Socket( socket_number, 0x0003 ) == 0x13)
        retval = 1;
    else
        CloseSocket( socket_number );
...
uint8_t ListenSocket( uint8_t socket_number )
{
    ...
    if ( ReadByteS5500Socket( socket_number, 0x0001 ) == 0x13 ) {

        WriteByteS5500Socket( socket_number, 0x0001, 0x02 );

        while( ReadByteS5500Socket( socket_number, 0x0001 ) );

        if ( ReadByteS5500Socket( socket_number, 0x0003 ) == 0x14 )
            retval = 1;
        else
            CloseSocket( socket_number );
    }
...
uint16_t SendSocket( uint8_t socket_number, const uint8_t *buf, uint16_t buflen )
{
    ...
    txsize = ReadShortS5500Socket( socket_number, 0x0020 );
    ...
    offaddr = ReadShortS5500Socket( socket_number, 0x0024 );

    PORTDbits.RD2 = 0; __nop(); __nop();
    WriteShortSPI1( offaddr );
    WriteByteSPI1( 0x00 | 0x04 | ( socket_number * 0x20 + 0x10 ) );
    while( buflen ) {
        buflen--;
    ...
    WriteShortS5500Socket( socket_number, 0x0024, offaddr );

    WriteByteS5500Socket( socket_number, 0x0001, 0x20 );


    while( ReadByteS5500Socket( socket_number, 0x0003 ) );
...
uint16_t ReceivSocket( uint8_t socket_number, uint8_t *buf, uint16_t buflen )
{
    ...
    offaddr = ReadShortS5500Socket( socket_number, 0x0028 );
    PORTDbits.RD2 = 0; __nop(); __nop();

 WriteShortSPI1( offaddr );
 WriteByteSPI1( 0x00 | 0x00 | ( socket_number * 0x20 + 0x18 ) );
    ...
    *buf='\0';
    ...
    WriteByteS5500Socket( socket_number, 0x0001, 0x40 );
...
uint16_t ReceivSocketSize( uint8_t socket_number )
{
    return ReadByteS5500Socket( socket_number, 0x0026 );
}
