...
void MCP41010Write(unsigned int data) {
    ...
    PORTAbits.RA0 = 0; PORTAbits.RA2 = 0; __nop(); __nop();
    unsigned int temp = 0b00010000 | 0b00000001;
    for( unsigned char i = 0; i < 8; i++ ){
        PORTAbits.RA0 = (temp & 0x80) ? 1 : 0; _delay((unsigned long)((1)*(32000000UL/4000000.0)));
        PORTAbits.RA1 = 1; __nop(); __nop(); __nop(); PORTAbits.RA1 = 0; __nop(); __nop(); __nop();
        temp = temp << 1;
    }
    temp = data;
    for( unsigned char i = 0; i < 8; i++ ){
    ...
    __nop(); __nop(); PORTAbits.RA2 = 1;
}

void MCP41010Reset() {
    PORTAbits.RA0 = 0; PORTAbits.RA2 = 0; __nop(); __nop();
    unsigned int temp = 0b00100000 | 0b00000001 | 0b00000001;
    for( unsigned char i = 0; i < 8; i++ ){
        PORTAbits.RA0 = (temp & 0x80) ? 1 : 0; _delay((unsigned long)((1)*(32000000UL/4000000.0)));
        PORTAbits.RA1 = 1; __nop(); __nop(); __nop(); PORTAbits.RA1 = 0; __nop(); __nop(); __nop();
        temp = temp << 1;
