...
unsigned char* Ds1307HMSRead(){
    ...
    real_rtc_data[0] = I2cRead( 0 );
    real_rtc_data[1] = I2cRead( 0 );
    real_rtc_data[2] = I2cRead( 1 );
    I2cStop();
    rtc_clock_disp_type = ( real_rtc_data[ 2 ] & 0x40 ) ? 1 : 0;
    if( rtc_clock_disp_type == 0 ) real_rtc_data[ 2 ] = real_rtc_data[ 2 ] & 0x3f;
    else { rtc_hour_ampm_flg = ( real_rtc_data[ 2 ] & 0x20 ) ? 1 : 0; real_rtc_data[ 2 ] = real_rtc_data[ 2 ] & 0x1f; }
    ...
    ds1307_date_datas[ 2 ] = real_rtc_data[ 1 ] >> 4; ds1307_date_datas[ 3 ] = real_rtc_data[ 1 ] % 16;
    ds1307_date_datas[ 4 ] = real_rtc_data[ 0 ] >> 4; ds1307_date_datas[ 5 ] = real_rtc_data[ 0 ] % 16;
    if( rtc_clock_disp_type == 1 && ds1307_date_datas[ 0 ] == 0 ) ds1307_date_datas[ 0 ] = 0xff;
    return ds1307_date_datas;
}
...
void Ds1307Write(unsigned char* write_datas){
    ...
    I2cWrite( (0xD0) );
    I2cWrite( 0x00 );
    I2cWrite( write_datas[ 0 ] );
    I2cWrite( write_datas[ 1 ] );
    I2cWrite( write_datas[ 2 ] );
    I2cWrite( write_datas[ 3 ] );
    I2cWrite( write_datas[ 4 ] );
    I2cWrite( write_datas[ 5 ] );
    I2cWrite( write_datas[ 6 ] );
    I2cWrite( 0x90 );
    I2cStop();
}
...
void Ds1307HourSet(unsigned char hour_data){
    ...
    if( rtc_clock_disp_type == 1 ) {
        ...
        if( rtc_hour_ampm_flg == 1 && hour_temp < 0x12 ) {
