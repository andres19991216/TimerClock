...
# 56 "./Buttons.h"
    ...
    unsigned int continue_pressed_cnt;

    unsigned char BTN_CLICK_STATE, BTN_CLICK_EVENT;

    _Bool btn_press_verify_flg, btn_long_press_verify_flg;

    unsigned int CONTINUE_PRESSED_TIME = 0;
    unsigned int long_pressed_cnt = 0;
...
unsigned char rtc_default_values[10] = {0x10,0x12,0x09,0x05,0x30,0x11,0x23,'\0'};
...
# 29 "./Counter.h"
    ...
    _Bool counter_enable_flg;
    _Bool counter_direction_flg;
    _Bool counter_skip_flg;
    _Bool counter_seting_flg;
    _Bool counter_down_comp_flg;
...
# 1 "./Display.h" 1
# 45 "./Display.h"
    unsigned char display_datas[ 7 + 1 ];
    _Bool blink_pos[ 7 + 1 ];
    ...
    void DecimalTo7SegmentDecode( unsigned long int decimal_data, unsigned char start_pos, unsigned char end_pos, _Bool zero_mode );
# 6 "Buttons.c" 2

# 1 "./DS1307.h" 1
# 76 "./DS1307.h"
    _Bool rtc_clock_disp_type;
    _Bool rtc_hour_ampm_flg;
...
void OpenButtons(){
    ...
    BTN_CLICK_STATE = 0; BTN_CLICK_EVENT = 0;
    ...
    btn_press_verify_flg = 0; btn_long_press_verify_flg = 0;
    CONTINUE_PRESSED_TIME = 100;
}

void ScanButtons(){

    if( PORTAbits.RA7 == 0 ) { hour_btn_released_cnt = 0; hour_btn_pressed_cnt ++; BTN_CLICK_EVENT = 1; }
    if( PORTAbits.RA7 == 1 && BTN_CLICK_EVENT == 1 ){ hour_btn_pressed_cnt = 0; hour_btn_released_cnt ++; }

    if( PORTAbits.RA4 == 0 ) { up_btn_released_cnt = 0; up_btn_pressed_cnt ++; BTN_CLICK_EVENT = 2; }
    if( PORTAbits.RA4 == 1 && BTN_CLICK_EVENT == 2 ){ up_btn_pressed_cnt = 0; up_btn_released_cnt ++; }

    if( PORTAbits.RA6 == 0 ) { down_btn_released_cnt = 0; down_btn_pressed_cnt ++; BTN_CLICK_EVENT = 3; }
    if( PORTAbits.RA6 == 1 && BTN_CLICK_EVENT == 3 ){ down_btn_pressed_cnt = 0; down_btn_released_cnt ++; }

    if( PORTBbits.RB4 == 0 ) { sel_btn_released_cnt = 0; sel_btn_pressed_cnt ++; BTN_CLICK_EVENT = 4; }
    if( PORTBbits.RB4 == 1 && BTN_CLICK_EVENT == 4 ){ sel_btn_pressed_cnt = 0; sel_btn_released_cnt ++; }

    if( PORTDbits.RD6 == 0 ) { reset_btn_released_cnt = 0; reset_btn_pressed_cnt ++; BTN_CLICK_EVENT = 5; }
    if( PORTDbits.RD6 == 1 && BTN_CLICK_EVENT == 5 ){ reset_btn_pressed_cnt = 0; reset_btn_released_cnt ++; }
...
void VerifyButtons(){
    ...
    switch( BTN_CLICK_EVENT ) {
        ...
        case 1: if( hour_btn_pressed_cnt > 1200 ) { if( !btn_long_press_verify_flg ) BTN_CLICK_STATE = 16; btn_long_press_verify_flg = 1; hour_btn_pressed_cnt = 1200; ActionButtons(); }
                else if( hour_btn_pressed_cnt > 50 ) { if( !btn_press_verify_flg ) BTN_CLICK_STATE = 11; btn_press_verify_flg = 1; ActionButtons(); }
                if( hour_btn_released_cnt > 5 ) {
                    hour_btn_released_cnt = 0; BTN_CLICK_EVENT = 0; btn_long_press_verify_flg = 0; btn_press_verify_flg = 0; BTN_CLICK_STATE = 0;
                }
                break;

        case 2: if( up_btn_pressed_cnt > 1200 ) { if( !btn_long_press_verify_flg ) BTN_CLICK_STATE = 17; btn_long_press_verify_flg = 1; up_btn_pressed_cnt = 1200; ActionButtons(); }
                else if( up_btn_pressed_cnt > 50 ) { if( !btn_press_verify_flg ) BTN_CLICK_STATE = 12; btn_press_verify_flg = 1; ActionButtons(); }
                if( up_btn_released_cnt > 5 ) {
                    up_btn_released_cnt = 0; BTN_CLICK_EVENT = 0; btn_long_press_verify_flg = 0; btn_press_verify_flg = 0; BTN_CLICK_STATE = 0;
                }
                break;

        case 3: if( down_btn_pressed_cnt > 1200 ) { if( !btn_long_press_verify_flg ) BTN_CLICK_STATE = 18; btn_long_press_verify_flg = 1; down_btn_pressed_cnt = 1200; ActionButtons(); }
                else if( down_btn_pressed_cnt > 50 ) { if( !btn_press_verify_flg ) BTN_CLICK_STATE = 13; btn_press_verify_flg = 1; ActionButtons(); }
                if( down_btn_released_cnt > 5 ) {
                    down_btn_released_cnt = 0; BTN_CLICK_EVENT = 0; btn_long_press_verify_flg = 0; btn_press_verify_flg = 0; BTN_CLICK_STATE = 0;
                }
                break;

        case 4: if( sel_btn_pressed_cnt > 1200 ) { if( !btn_long_press_verify_flg ) BTN_CLICK_STATE = 19; btn_long_press_verify_flg = 1; sel_btn_pressed_cnt = 1200; ActionButtons(); }
                else if( sel_btn_pressed_cnt > 50 ) { if( !btn_press_verify_flg ) BTN_CLICK_STATE = 14; btn_press_verify_flg = 1; ActionButtons(); }
                if( sel_btn_released_cnt > 5 ) {
                    sel_btn_released_cnt = 0; BTN_CLICK_EVENT = 0; btn_long_press_verify_flg = 0; btn_press_verify_flg = 0;
                }
                break;

        case 5: if( reset_btn_pressed_cnt > 1200 ) { if( !btn_long_press_verify_flg ) BTN_CLICK_STATE = 20; btn_long_press_verify_flg = 1; reset_btn_pressed_cnt = 1200; ActionButtons(); }
                else if( reset_btn_pressed_cnt > 50 ) { if( !btn_press_verify_flg ) BTN_CLICK_STATE = 15; btn_press_verify_flg = 1; ActionButtons(); }
                if( reset_btn_released_cnt > 5 ) {
                    reset_btn_released_cnt = 0; BTN_CLICK_EVENT = 0; btn_long_press_verify_flg = 0; btn_press_verify_flg = 0;
                }
                break;
    }
}
...
void ActionButtons(){
    ...
    if( counter_down_comp_flg ) {
        blink_enable_flg = 0; counter_down_comp_flg = 0; SYSTEM_STATE_FLG = 203; BTN_CLICK_STATE = 0;
    }
    ...
    switch( SYSTEM_STATE_FLG ){
        ...
        case 100:
            switch( BTN_CLICK_STATE ) {
                case 14:
                    if( rtc_clock_disp_type == 0 ){
                        if( rtc_hour_ampm_flg == 0 && real_rtc_data[ 2 ] == 0 ) real_rtc_data[ 2 ] = 0x12;
                        rtc_clock_disp_type = 1;
                    }
                    else {
                        if( rtc_hour_ampm_flg == 0 && real_rtc_data[ 2 ] == 0x12 ) real_rtc_data[ 2 ] = 0x00;
                        rtc_clock_disp_type = 0;
                    }
                    BTN_CLICK_STATE = 0; Ds1307HourSet(real_rtc_data[ 2 ]);
                    return;
                case 11:
                    temp = real_rtc_data[ 2 ]; temp ++;
                    if( temp % 16 >= 10 ) temp += 6;
                    if( rtc_clock_disp_type == 0 ){
                        if( temp > 0x11 ) { rtc_hour_ampm_flg = 1; }
                        if( temp > 0x23 ) { temp = 0; rtc_hour_ampm_flg = 0; }
                    }
                    else if( rtc_clock_disp_type == 1 ){
                        if( temp > 0x12 ) temp = 1;
                        if( temp > 0x11 ) {
                            if( rtc_hour_ampm_flg == 1 ) rtc_hour_ampm_flg = 0;
                            else rtc_hour_ampm_flg = 1;
                        }
                    }
                    real_rtc_data[ 2 ] = temp;
                    Ds1307HourSet(real_rtc_data[ 2 ]);
                    BTN_CLICK_STATE = 0;
                    break;
                case 17:
                    continue_pressed_cnt ++;
                    if( continue_pressed_cnt > CONTINUE_PRESSED_TIME ) {
                        temp = real_rtc_data[ 1 ]; temp ++;
                        if( temp % 16 >= 10 ) temp += 6;
                        if( temp > 0x59 ) temp = 0;
                        real_rtc_data[ 1 ] = temp;
                        Ds1307MinuteSet(real_rtc_data[ 1 ]);
                        continue_pressed_cnt = 0;
                    }
                    return;
                case 18:
                    continue_pressed_cnt ++;
                    if( continue_pressed_cnt > CONTINUE_PRESSED_TIME ) {
                        temp = real_rtc_data[ 0 ]; temp ++;
                        if( temp % 16 >= 10 ) temp += 6;
                        if( temp > 0x59 ) temp = 0;
                        real_rtc_data[ 0 ] = temp;
                        Ds1307SecondSet(real_rtc_data[ 0 ]);
                        continue_pressed_cnt = 0;
                    }
                    return;
                case 12:
        ...
        case 200:
            switch( BTN_CLICK_STATE ) {
                case 14:
                    ...
                    if( !counter_enable_flg ) { SYSTEM_STATE_FLG = 200; StartCounter(); blink_enable_flg = 0; }
                    else { SYSTEM_STATE_FLG = 201; StopCounter(); blink_enable_flg = 0; }
        ...
        case 201:
            ...
            switch( BTN_CLICK_STATE ) {
                case 14:
                    ...
                    BTN_CLICK_STATE = 0; temp_system_state = SYSTEM_STATE_FLG;
                    return;
                case 15:
                    if( counter_direction_flg == 1 ){
                        counter_up_hour = 0;
                        counter_up_minute = 0;
                        counter_up_second = 0;
                    }
                    else if( counter_direction_flg == 0 ){
                ...
                case 20:
                    ...
                    return;
                case 12:
                    if( counter_direction_flg == 1 ) { BTN_CLICK_STATE = 0; return; }
                    SYSTEM_STATE_FLG = 202;
                    break;
                case 13:
                    if( counter_direction_flg == 1 ) { BTN_CLICK_STATE = 0; return; }
                    SYSTEM_STATE_FLG = 202;
            ...
            break;
        case 203:
            counter_direction_flg = 0;
            blink_enable_flg = 0;
            switch( BTN_CLICK_STATE ) {
                case 12:
                    SYSTEM_STATE_FLG = 202; break;
                case 13:
                    SYSTEM_STATE_FLG = 202; break;
                case 14:
                    SYSTEM_STATE_FLG = 200; StartCounter(); blink_enable_flg = 0;
                    BTN_CLICK_STATE = 0;
                    return;
                case 15:
                    counter_down_hour = counter_down_set_hour;
                    ...
                    return;
                case 20:
                    counter_direction_flg = 1;
                    SYSTEM_STATE_FLG = 201; StopCounter();
