...
//    #define SEG4_TRIS   TRISEbits.TRISE1
    ...
    #define DISP_BLINK_TIME  150
    #define DISP_BLINK_TIME1 80

    #define FOUR_SEG_TIME_VALUE 65085
    #define TWO_SEG_TIME_VALUE  65485
    #define LEDS_TIME_VALUE     65485

    signed char display_datas[ NUM_OF_7SEG_COMMON + NUM_OF_LEDS_COMMON ];
