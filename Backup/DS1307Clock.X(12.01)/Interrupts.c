...
//        WriteTimer0( 65285 );
        switch( display_cnt ){
            ...
            case 4: WriteTimer0( FOUR_SEG_TIME_VALUE ); break;
            case 5: WriteTimer0( FOUR_SEG_TIME_VALUE ); break;
        ...
        if( cnt1 == 1000 ){
            ...
            if( btn_long_press_verify_flg ){
                ...
                CONTINUE_PRESSED_TIME = BUTTON_CONTINUE_PRESSED_STEP_TIME / long_pressed_cnt; 
            }
            else {
                long_pressed_cnt = 0;
