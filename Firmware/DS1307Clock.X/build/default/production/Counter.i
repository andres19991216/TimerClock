...
unsigned char* ReadCounter(){
    ...
    counter_datas[ 0 + 1 ] = counter_hour % 10;
    counter_datas[ 0 ] = counter_hour / 10;
    counter_datas[ 2 + 1 ] = counter_minute % 10;
    counter_datas[ 2 ] = counter_minute / 10;
    counter_datas[ 4 + 1 ] = counter_second % 10;
    counter_datas[ 4 ] = counter_second / 10;
