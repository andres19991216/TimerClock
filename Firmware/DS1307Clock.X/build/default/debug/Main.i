...
void main(void) {
    ...
    while(1)
    {
        ...
        switch( SYSTEM_STATE_FLG ) {
            ...
            case 106:
            case 107:
            case 108: ClockSetting( rtc_clock_set_mode ); break;
        }
...
void DeviceInit(){
    ...
    counter_hour_set_value = 0; counter_min_set_value = 3; counter_sec_set_value = 50;

    SYSTEM_STATE_FLG = 100;
    rtc_clock_disp_mode = 0;
    rtc_clock_set_mode = 0;
    blink_enable_flg = 1;
}
...
void ClockSetting( unsigned char set_mod ) {
    switch( set_mod ) {
        case 0:
            display_datas[0] = MarkDisplay( real_rtc_data[ 6 ] >> 4 );
            display_datas[1] = MarkDisplay( real_rtc_data[ 6 ] % 16 );
            display_datas[2] = MarkDisplay( real_rtc_data[ 5 ] >> 4 );
            display_datas[3] = MarkDisplay( real_rtc_data[ 5 ] % 16 );
            display_datas[4] = MarkDisplay( real_rtc_data[ 4 ] >> 4 );
            display_datas[5] = MarkDisplay( real_rtc_data[ 4 ] % 16 );
            break;
        case 1:
            ...
            break;
        case 2:
            display_datas[0] = MarkDisplay( real_rtc_data[ 3 ] >> 4 );
            display_datas[1] = MarkDisplay( real_rtc_data[ 3 ] % 16 );
            display_datas[2] = 0xff;
            display_datas[3] = 0xff;
...
void LEDProcess() {
    display_datas[ 7 ] |= 0xff;
    if( SYSTEM_STATE_FLG == 100 ) {
        if( rtc_clock_disp_type == 0 ) display_datas[ 7 ] &= 0xfe;
        else display_datas[ 7 ] &= 0xfd;
    }
}
