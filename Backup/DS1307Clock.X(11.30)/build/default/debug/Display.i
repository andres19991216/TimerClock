...
void OpenDisplay(){
    ...
    LATCbits.LATC2 = LATCbits.LATC1 = LATCbits.LATC0 = LATCbits.LATC5 = LATBbits.LATB1 = LATBbits.LATB5 = LATDbits.LATD7 = LATBbits.LATB0 = 1;

    M74HC595Init();


    for( unsigned char i = 0; i < 7 + 1; i++ ){
        blink_pos[ i ] = 0;
...
void ScanDisplay(){
# 52 "Display.c"
    LATCbits.LATC2 = LATCbits.LATC1 = LATCbits.LATC0 = LATCbits.LATC5 = LATBbits.LATB1 = LATBbits.LATB5 = LATDbits.LATD7 = LATBbits.LATB0 = 0;
    display_cnt ++;
    if( blink_pos[ display_cnt - 1 ] && blink_cnt < BLINK_TIME / 2 ) return;
    switch( display_cnt ){
        case 1: M74HC595Write(display_datas[0]); LATCbits.LATC2 = 1; break;
        case 2: M74HC595Write(display_datas[1]); LATCbits.LATC1 = 1; break;
        case 3: M74HC595Write(display_datas[2]); LATCbits.LATC0 = 1; break;
        case 4: M74HC595Write(display_datas[3]); LATCbits.LATC5 = 1; break;
        case 5: M74HC595Write(display_datas[4]); LATBbits.LATB1 = 1; break;
        case 6: M74HC595Write(display_datas[5]); LATBbits.LATB5 = 1; break;
        case 7: if( blink_pos[ 6 ] ) M74HC595Write(0x00); else M74HC595Write(0xff); LATDbits.LATD7 = 1; break;
        case 8: M74HC595Write(display_datas[7]); LATBbits.LATB0 = 1; display_cnt = 0; blink_cnt ++; break;
    }
