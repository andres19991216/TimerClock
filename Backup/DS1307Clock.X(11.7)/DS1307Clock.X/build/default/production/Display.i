...
void ScanDisplay(){
    ...
    switch( display_cnt ){
        case 1: TLC5917Write(display_datas[0]); LATCbits.LATC2 = 0; break;
        case 2: TLC5917Write(display_datas[1]); LATCbits.LATC1 = 0; break;
        case 3: TLC5917Write(display_datas[2]); LATCbits.LATC0 = 0; break;
        case 4: TLC5917Write(display_datas[3]); LATCbits.LATC5 = 0; break;
        case 5: TLC5917Write(display_datas[4]); LATBbits.LATB1 = 0; break;
        case 6: TLC5917Write(display_datas[5]); LATBbits.LATB5 = 0; break;
        case 7: if( blink_pos[ 6 ] ) TLC5917Write( 0xff ); else TLC5917Write( 0x00 ); LATDbits.LATD7 = 0; break;
        case 8: TLC5917Write(display_datas[7]); LATBbits.LATB0 = 0; display_cnt = 0; blink_cnt ++; break;
    }
