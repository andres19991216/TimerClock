...
void VerifyButtons(){
    ...
    switch( BTN_CLICK_EVENT ) {
        ...
        case 1: if( hour_btn_pressed_cnt > 2000 ) { if( !btn_long_press_verify_flg ) BTN_CLICK_STATE = 16; btn_long_press_verify_flg = 1; hour_btn_pressed_cnt = 2000; ActionButtons(); }
                ...
                if( hour_btn_released_cnt > 5 ) {
                    hour_btn_released_cnt = 0; BTN_CLICK_EVENT = 0; BTN_CLICK_EVENT = 0; btn_long_press_verify_flg = 0; btn_press_verify_flg = 0;
                }
                break;

        case 2: if( up_btn_pressed_cnt > 2000 ) { if( !btn_long_press_verify_flg ) BTN_CLICK_STATE = 17; btn_long_press_verify_flg = 1; up_btn_pressed_cnt = 2000; ActionButtons(); }
                ...
                if( up_btn_released_cnt > 5 ) {
                    up_btn_released_cnt = 0; BTN_CLICK_EVENT = 0; BTN_CLICK_EVENT = 0; btn_long_press_verify_flg = 0; btn_press_verify_flg = 0; BTN_CLICK_STATE = 0;
                }
                break;

        case 3: if( down_btn_pressed_cnt > 2000 ) { if( !btn_long_press_verify_flg ) BTN_CLICK_STATE = 18; btn_long_press_verify_flg = 1; down_btn_pressed_cnt = 2000; ActionButtons(); }
                ...
                if( down_btn_released_cnt > 5 ) {
                    down_btn_released_cnt = 0; BTN_CLICK_EVENT = 0; BTN_CLICK_EVENT = 0; btn_long_press_verify_flg = 0; btn_press_verify_flg = 0; BTN_CLICK_STATE = 0;
                    if( btn_long_press_verify_flg ) { btn_long_press_verify_flg = 0; }
                    else if( btn_press_verify_flg ) { btn_press_verify_flg = 0; }
                }
                break;

        case 4: if( sel_btn_pressed_cnt > 2000 ) { if( !btn_long_press_verify_flg ) BTN_CLICK_STATE = 19; btn_long_press_verify_flg = 1; sel_btn_pressed_cnt = 2000; ActionButtons(); }
                ...
                if( sel_btn_released_cnt > 5 ) {
                    sel_btn_released_cnt = 0; BTN_CLICK_EVENT = 0; BTN_CLICK_EVENT = 0; btn_long_press_verify_flg = 0; btn_press_verify_flg = 0;
                }
                break;

        case 5: if( reset_btn_pressed_cnt > 2000 ) { if( !btn_long_press_verify_flg ) BTN_CLICK_STATE = 20; btn_long_press_verify_flg = 1; reset_btn_pressed_cnt = 2000; ActionButtons(); }
        ...
        case 100:
            switch( BTN_CLICK_STATE ) {
                case 14:
                    ...
                    BTN_CLICK_STATE = 0; Ds1307Write( &real_rtc_data );
                    return;
                case 11:
                    SYSTEM_STATE_FLG = 101;
                    break;
                case 12:
                    SYSTEM_STATE_FLG = 101;
                    break;
        ...
        case 200:
            switch( BTN_CLICK_STATE ) {
                case 14:
                    ...
                    if( !counter_enable_flg ) { SYSTEM_STATE_FLG = 200; StartCounter(); blink_enable_flg = 1; }
        ...
        case 203:
            ...
            switch( BTN_CLICK_STATE ) {
                ...
                case 13:
                    SYSTEM_STATE_FLG = 202; break;
                case 14:
                    SYSTEM_STATE_FLG = 200; StartCounter(); blink_enable_flg = 1;
                    BTN_CLICK_STATE = 0;
                    return;
                case 15:
                    counter_down_hour = 0;
